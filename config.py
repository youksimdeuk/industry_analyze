"""
산업분석 자동화 설정 파일 (환경변수 기반)

필수 환경변수:
- OPENAI_API_KEY

Google 인증:
- GOOGLE_CREDENTIALS_PATH / GOOGLE_TOKEN_PATH (파일 경로)
또는
- GOOGLE_CREDENTIALS_JSON / GOOGLE_TOKEN_JSON (Secrets 문자열)
...
# 발행 완료 알림 Webhook (선택 — Slack 또는 Discord)
